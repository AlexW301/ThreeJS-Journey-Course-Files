...
const hemishpereLight = new THREE.HemisphereLight(0xff0000, 0x0000ff, 0.3)
...
const rectAreaLight = new THREE.RectAreaLight(0x4e00ff, 2, 10, 1)
...
// Helpers
const hemishpereLightHelper = new THREE.HemisphereLightHelper(hemishpereLight, 0.2)
