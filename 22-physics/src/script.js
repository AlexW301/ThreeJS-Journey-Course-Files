...
debugObject.createSphere = () => {
    createSphere(Math.random() * 0.5, new THREE.Vector3((Math.random() - 0.5) * 3, 3, 0))
}
gui.add(debugObject, 'createSphere')

// debugObject.createBox = () => {
//     createBox(Math.random() * 0.5, new THREE.Vector3((Math.random() - 0.5) * 3, 3, 0))
// }
...
// createSphere(.5, new THREE.Vector3(0, 3, 0))
